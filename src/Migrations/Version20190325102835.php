 ...
 */
final class Version20190325102835 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE image_id image_id INT DEFAULT NULL, CHANGE hours_per_day hours_per_day INT DEFAULT NULL, CHANGE mtbf mtbf INT DEFAULT NULL, CHANGE contractual_quantity contractual_quantity INT DEFAULT NULL, CHANGE is_calculated is_calculated TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE report ADD contractual_quantity INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE repair_time repair_time INT DEFAULT NULL, CHANGE mtbf mtbf NUMERIC(10, 2) DEFAULT NULL, CHANGE mttr mttr NUMERIC(10, 2) DEFAULT NULL, CHANGE rate rate NUMERIC(5, 2) DEFAULT NULL, CHANGE current_issue_quantity current_issue_quantity INT DEFAULT NULL, CHANGE subcontractor_issue_quantity subcontractor_issue_quantity INT DEFAULT NULL, CHANGE degradation_quantity degradation_quantity INT DEFAULT NULL, CHANGE new_issue_quantity new_issue_quantity INT DEFAULT NULL, CHANGE is_calculated is_calculated TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE report DROP contractual_quantity, CHANGE category_id category_id INT DEFAULT NULL, CHANGE repair_time repair_time INT DEFAULT NULL, CHANGE mtbf mtbf NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE mttr mttr NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE rate rate NUMERIC(5, 2) DEFAULT \'NULL\', CHANGE current_issue_quantity current_issue_quantity INT DEFAULT NULL, CHANGE subcontractor_issue_quantity subcontractor_issue_quantity INT DEFAULT NULL, CHANGE degradation_quantity degradation_quantity INT DEFAULT NULL, CHANGE new_issue_quantity new_issue_quantity INT DEFAULT NULL, CHANGE is_calculated is_calculated TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE search CHANGE equipment_id equipment_id INT DEFAULT NULL, CHANGE site_id site_id INT DEFAULT NULL, CHANGE brand_id brand_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE operator_id operator_id INT DEFAULT NULL, CHANGE contract_id contract_id INT DEFAULT NULL, CHANGE transportation_id transportation_id INT DEFAULT NULL');

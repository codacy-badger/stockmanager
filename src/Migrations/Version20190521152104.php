 ...
 */
final class Version20190521152104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document ADD repair_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE document ADD CONSTRAINT FK_D8698A7643833CFF FOREIGN KEY (repair_id) REFERENCES repair (id)');
        $this->addSql('CREATE INDEX IDX_D8698A7643833CFF ON document (repair_id)');
        ...
        $this->addSql('ALTER TABLE repair DROP document_file_id, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL, CHANGE issue_id issue_id INT DEFAULT NULL, CHANGE software_id software_id INT DEFAULT NULL, CHANGE degradation degradation TINYINT(1) DEFAULT NULL, CHANGE no_breakdown no_breakdown TINYINT(1) DEFAULT NULL, CHANGE time_to_repair time_to_repair INT DEFAULT NULL, CHANGE stats_download stats_download TINYINT(1) DEFAULT NULL, CHANGE soft_upload soft_upload TINYINT(1) DEFAULT NULL, CHANGE soft_version soft_version VARCHAR(255) DEFAULT NULL, CHANGE unavailability unavailability INT DEFAULT NULL, CHANGE is_going_to_subcontractor is_going_to_subcontractor TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE image_id image_id INT DEFAULT NULL, CHANGE hours_per_day hours_per_day INT DEFAULT NULL, CHANGE mtbf mtbf INT DEFAULT NULL, CHANGE contractual_quantity contractual_quantity INT DEFAULT NULL, CHANGE is_embeded is_embeded TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE delivery CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A7643833CFF');
        $this->addSql('DROP INDEX IDX_D8698A7643833CFF ON document');
        $this->addSql('ALTER TABLE document DROP repair_id, CHANGE name name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE equipment CHANGE brand_id brand_id INT DEFAULT NULL, CHANGE contract_id contract_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE part_group CHANGE category_id category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE part_quantity CHANGE part_id part_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE repair ADD document_file_id INT DEFAULT NULL, CHANGE technician_id technician_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL, CHANGE software_id software_id INT DEFAULT NULL, CHANGE issue_id issue_id INT DEFAULT NULL, CHANGE degradation degradation TINYINT(1) DEFAULT \'NULL\', CHANGE no_breakdown no_breakdown TINYINT(1) DEFAULT \'NULL\', CHANGE time_to_repair time_to_repair INT DEFAULT NULL, CHANGE stats_download stats_download TINYINT(1) DEFAULT \'NULL\', CHANGE soft_upload soft_upload TINYINT(1) DEFAULT \'NULL\', CHANGE soft_version soft_version VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE unavailability unavailability INT DEFAULT NULL, CHANGE is_going_to_subcontractor is_going_to_subcontractor TINYINT(1) DEFAULT \'NULL\'');

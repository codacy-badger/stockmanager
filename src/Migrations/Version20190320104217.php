 ...
 */
final class Version20190320104217 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, issue_quantity INT NOT NULL, fake_issue_quantity INT NOT NULL, repair_time INT DEFAULT NULL, mtbf NUMERIC(10, 2) DEFAULT NULL, mttr NUMERIC(10, 2) DEFAULT NULL, rate NUMERIC(5, 2) DEFAULT NULL, UNIQUE INDEX UNIQ_C42F778412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

 ...
 */
final class Version20190129121043 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE equipment_status (id INT AUTO_INCREMENT NOT NULL, equipment_id INT DEFAULT NULL, start_failure DATETIME DEFAULT NULL, end_failure DATETIME DEFAULT NULL, INDEX IDX_DC8E1A5C517FE9FE (equipment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

 ...
 */
final class Version20190207142438 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subcontractor_repair ADD date_return DATE DEFAULT NULL, DROP date_exit, CHANGE repair_id repair_id INT DEFAULT NULL, CHANGE date_entry date_entry DATE DEFAULT NULL, CHANGE date_dispatch date_dispatch DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subcontractor_repair ADD date_exit DATE DEFAULT \'NULL\', DROP date_return, CHANGE repair_id repair_id INT DEFAULT NULL, CHANGE date_entry date_entry DATE DEFAULT \'NULL\', CHANGE date_dispatch date_dispatch DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE symptom CHANGE position position SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE authorization_id authorization_id INT DEFAULT NULL, CHANGE operator_id operator_id INT DEFAULT NULL');
    }
}

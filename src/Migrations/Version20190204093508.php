 ...
 */
final class Version20190204093508 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE part_group ADD CONSTRAINT FK_FEB3132612469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('CREATE INDEX IDX_FEB3132612469DE2 ON part_group (category_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE part_group DROP FOREIGN KEY FK_FEB3132612469DE2');
        $this->addSql('DROP INDEX IDX_FEB3132612469DE2 ON part_group');
        $this->addSql('ALTER TABLE part_group CHANGE category_id category_id INT DEFAULT NULL');

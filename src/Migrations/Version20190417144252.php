 ...
 */
final class Version20190417144252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE software ADD brand_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE software ADD CONSTRAINT FK_77D068CF44F5D008 FOREIGN KEY (brand_id) REFERENCES brand (id)');
        $this->addSql('CREATE INDEX IDX_77D068CF44F5D008 ON software (brand_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE software DROP FOREIGN KEY FK_77D068CF44F5D008');
        $this->addSql('DROP INDEX IDX_77D068CF44F5D008 ON software');
        $this->addSql('ALTER TABLE software DROP brand_id');
